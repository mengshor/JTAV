...
from keras.layers import Input, Dense, Permute, Concatenate, Lambda
...
m_1 = MatMul((input_dim_1[0], 1), (1, input_dim_2[0]))([x_1, x_2])
m_2 = MatMul((input_dim_1[0], 1), (1, input_dim_3[0]))([x_1, x_3])
m_3 = MatMul((input_dim_2[0], 1), (1, input_dim_3[0]))([x_2, x_3])

h_1 = AttentionWithContext(hidden_dim=hidden)(m_1)
m_1 = Permute((2, 1))(m_1)
h_2 = AttentionWithContext(hidden_dim=hidden)(m_1)
m_1 = Concatenate()([h_1, h_2])

h_3 = AttentionWithContext(hidden_dim=hidden)(m_2)
m_2 = Permute((2, 1))(m_2)
h_4 = AttentionWithContext(hidden_dim=hidden)(m_2)
m_2 = Concatenate()([h_3, h_4])
#
h_5 = AttentionWithContext(hidden_dim=hidden)(m_3)
m_3 = Permute((2, 1))(m_3)
h_6 = AttentionWithContext(hidden_dim=hidden)(m_3)
m_3 = Concatenate()([h_5, h_6])

x = Concatenate()([m_1, m_2, m_3])
rep = x
